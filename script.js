(() => {
  ...
  const revealTargets = document.querySelectorAll(
    '.about__story, .about__timeline li, .spec-sheet, .schematic-wrap, .service-card, .skills__group, .process__step, .project-card, .certs__row, .testimonial-card, .faq__item, .contact__grid > *'
  );
